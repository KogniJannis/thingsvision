...
Code from:
model-vs-human which has it from:
...
__all__ = ['ResNet50_SIN', 'ResNet50_SIN_IN', 'ResNet50_SIN_IN_IN', 'VGG16_SIN', 'AlexNet_SIN']
...
class ResNet50_SIN_IN_IN(Custom):
    def __init__(self, device, parameters) -> None:
        super().__init__(device)
        self.backend = "pt"
